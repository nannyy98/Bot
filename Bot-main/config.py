...
BOT_TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '')  # задайте через ENV на сервере

POST_CHANNEL_ID = os.getenv('POST_CHANNEL_ID', '')  # задайте через ENV
...
# Совместное подключение к Postgres (Render)
